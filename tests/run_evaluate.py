...
from coreason_deep_research.deep_researcher import deep_researcher_builder
...
async def target(
    ...
    return await graph.ainvoke({"messages": [{"role": "user", "content": inputs["messages"][0]["content"]}]}, config)
