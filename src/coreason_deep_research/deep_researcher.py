...
from coreason_deep_research.configuration import (
    Configuration,
)
from coreason_deep_research.prompts import (
...
from coreason_deep_research.state import (
    AgentInputState,
    AgentState,
    ClarifyWithUser,
    ConductResearch,
...
from coreason_deep_research.utils import (
...
async def researcher_tools(
    ...
    for tool_call in tool_calls:
        ...
        if tool_name in tools_by_name:
            task = execute_tool_safely(tools_by_name[tool_name], tool_call["args"], config)
        else:

            async def report_unknown_tool(name=tool_name):
                return f"Error: Tool '{name}' is not available."

            task = report_unknown_tool()
